...
<div class="justify-center flex-1 max-w-6xl px-4 py-2 mx-auto lg:py-4">
<div class="flex flex-wrap py-4 -mx-3">
<div class="w-full px-4 mb-7 md:w-1/2 lg:w-4/12 lg:mb-0">
<a href="#" class="inline-block pb-2 text-lg font-bold ">About Company</a>
<div class="w-16 mb-4 border-b-2 border-blue-600"></div>
<p class="text-base font-normal leading-6 lg:w-64 ">
Perfectly craft your home with our team of expert designers. </p>
</div>
...
<h2 class="pb-2 text-lg font-bold text-gray-800 ">
Features </h2>
<div class="w-16 mb-4 border-b-2 border-blue-600 ">
</div>
<ul>
<li class="mb-4">
<a href="#" class="inline-block text-base font-normal ">Home</a>
...
<span class="text-gray-800 ">Addis Ababa, Ethiopia</span>
</p>
<p class="flex items-center mb-4 ">
...
<span class="text-gray-800 ">surafelldejen@gmail.com</span>
</p>
<p class="flex items-center mb-4">
...
<span class="text-gray-800">+251-919891726</span>
</p>
</div>
</div>
</div>
...
<a href="#" class="mr-4 text-gray-600 dark:text-gray-400 hover:text-blue-700">
