...
const Contact = () => {
  return (
    ...
    <section
    id='contact'
        class="flex items-center bg-gradient-to-r from-gray-50 to-sky-50 xl:h-screen font-poppins dark:from-gray-900 dark:to-gray-900 ">
        <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-10 md:px-7">
            <div class="flex flex-wrap items-center justify-center -mx-4">
                <div class="w-full px-4 lg:w-1/2">
                    <div class="max-w-sm mx-auto ">
                        <div
                            class="p-6 mb-6 text-center bg-white border rounded-md shadow dark:border-gray-800 dark:bg-gray-800">
                            <form action="">
                                <div class="mb-6">
                ...
                <div class="max-w-2xl px-4 mb-16 lg:mb-0 lg:w-1/2 lg:mr-0 lg:ml-auto">
                    <h2 class="mb-6 text-3xl font-bold dark:text-gray-400">Get In <span
                            class="text-sky-600 dark:text-sky-400">Touch</span>
                    </h2>
